...
if true
    ...
    %% bool=GetIsConnected(this)
    %- should be connected
    IsConnected = Controller.PicomotorScrews.(NameOfPicomotorScrew).GetConnectionStatus;
end

if true
    %% -Define alias of axis, motor properties, controller device number
    Alias = 'placeholderName4';
    MotorProperties = struct('ChannelNumber',4,  ...
                             'MotorType', 2,...
                             'HomePosition', 0,...
                             'Velocity', 400, ...
                             'Acceleration', 100);                                
